"""Vision transformer image encoder blocks for MR-IPT.

Code adapted from Segment Anything and ViTDet.
"""
...
class Block(nn.Module):
    """Transformer block supporting window attention and residual connections."""
